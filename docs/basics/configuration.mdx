...
```json title="gleece.config.json"
{
    "commonConfig": { // Mandatory
        ...
        "allowPackageLoadFailures": false // Optional - If set to true, Gleece will ignore package load failures and continue processing. (e.g., if some files have syntax errors, missing properties, etc.)
    },
    "routesConfig": { // Mandatory
        ...
        "authorizationConfig": { // Mandatory
            "authFileFullPackageName": "<package>", // Mandatory - The package where the authorization function "GleeceRequestAuthorization" is implemented (e.g. github.com/gopher-fleece/gleece/v2/auth)
        ...
        "skipGenerateDateComment": false // Optional - If set to true, Gleece will not generate the date comment at the top of the generated routes file
    },
