...
Route handlers in Gleece follow a consistent return pattern. While the return type is optional, when specified, it should be a tuple in the form of `(interface{}, error)`:
