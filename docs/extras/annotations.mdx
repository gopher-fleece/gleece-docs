...
| `@TemplateContext` | Defines custom context data for templates                  | contextKey         | Any JSON5 object                      | No       | Supports multiple annotations with unique contextKey values. See [Custom Context](/docs/customization/custom_context) for more details  |
