...
Gleece supports using types from imported packages in your route function parameters and return types. This includes:

- Structs defined in external packages
- Primitive type aliases (like enums) from imported modules
- Any other Go types that are compatible with Gleece's parameter handling
