...
:::info Supported routers engines

Gleece supports **Gin, Echo, Gorilla Mux, Chi, & Fiber** routers.
...
See the full [configuration](/docs/advanced/configuration.mdx) documentation for detailed explanation of all available properties.
