...
As we've demonstrated, when using unit DTOs, our code remains fully agnostic to the unit quantities sent by consumers. However, if a consumer isn't using unit DTOs and requires a consistent unit, that's easy to accommodate as well.
